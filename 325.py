...
df=pd.read_csv("/Users/kassemhajjoul/Desktop/2019.csv")
st.header("Our Data:")
...
ax1=px.scatter(df, x="Score", y="GDP_per_capita", color="Social_support", size = "Freedom")
...
ax4=px.bar(df,Top_countries,Top_scores)
st.plotly_chart(ax4)
...
ax5=px.histogram(df,x="Healthy_life_expectancy",hover_name="Country",color="Country")
st.plotly_chart(ax5)
x=df['Country']
y=df['Score']
z=df["Corruption"]
